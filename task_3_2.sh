#!/bin/sh
yes | cp -a instance/monitor/center/plugin_config.cfg.task_3_2 instance/monitor/center/plugin_config.cfg 
yes | cp instance/monitor/center/aspect_policy.cfg.task_3_2 instance/monitor//center/aspect_policy.cfg 
